    ...
    var e = {
            ...
            425: (e, t, r) => {
                r(55),
                    (e.exports = function (e) {
                        return (
                            "" +
                            '<div class="modal fade" id="image-multiple-modal" tabindex="-1" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header">\x3c!--h5.modal-title File Error--\x3e<button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></div><div class="modal-body"></div><div class="modal-footer"><button class="btn btn-primary" type="button" data-dismiss="modal">Close</button></div></div></div></div>'
                        );
                    });
            },
            152: (e, t, r) => {
                ...
                e.exports = function (e) {
                    ...
                    return (
                        function (e, a) {
                            (r +=
                                '<div class="container-fluid" id="uploaderCont"><div class="row ddHandler"><div class="col-12" id="dragandrophandler"><svg class="bi bi-upload" width="1em" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M.5 8a.5.5 0 01.5.5V12a1 1 0 001 1h12a1 1 0 001-1V8.5a.5.5 0 011 0V12a2 2 0 01-2 2H2a2 2 0 01-2-2V8.5A.5.5 0 01.5 8zM5 4.854a.5.5 0 00.707 0L8 2.56l2.293 2.293A.5.5 0 1011 4.146L8.354 1.5a.5.5 0 00-.708 0L5 4.146a.5.5 0 000 .708z" clip-rule="evenodd"></path><path fill-rule="evenodd" d="M8 2a.5.5 0 01.5.5v8a.5.5 0 01-1 0v-8A.5.5 0 018 2z" clip-rule="evenodd"></path></svg><span>Glisser déposer votre fichier ou<label>Parcourir<form method="post" action="" enctype="multipart/form-data"><input value="" id="fileupload11" name="browse[]" type="file" style="display: none;" multiple></form></label></span></div></div>\x3c!--.row.fileQueue--\x3e<div class="row queueSrc"><div class="col name"><b></b><span style="display:none"></span></div>'),
                                a && (r += '<div class="col desc"><input class="form-control form-control-sm" type="text" placeholder="Description of file" maxlength="100"></div>'),
                                e &&
                                    ...
                                    (r += "</select></div>")),
                                (r +=
                                    '<div class="col-2 remove"><input class="btn btn-sm btn-outline-danger" type="button" value="x" data-name></div></div><div class="row ulProgress">\x3c!--.col.d-none--\x3e<div class="col">Uploading...<div class="progress"><div class="progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="100">0%</div></div></div></div><div class="row submit"><div class="col-12 text-right"></div></div></div>');
                        }.call(this, "options" in a ? a.options : "undefined" != typeof options ? options : void 0, "showDesc" in a ? a.showDesc : "undefined" != typeof showDesc ? showDesc : void 0),
                        r
                    );
                };
            },
            55: (e, t, r) => {
                ...
                function i(e, t, r, o) {
                    ...
                    var a = typeof t;
                    return (
                        ("object" !== a && "function" !== a) || "function" != typeof t.toJSON || (t = t.toJSON()),
            ...
            379: (e) => {
                ...
                function o(e, o) {
                    for (var n = {}, i = [], s = 0; s < e.length; s++) {
                        ...
                        -1 !== p ? (t[p].references++, t[p].updater(f)) : t.push({ identifier: u, updater: a(f, o), references: 1 }), i.push(u);
                    }
                    return i;
                }
                function a(e, t) {
            ...
            (v.styleTagTransform = p()),
                ...
                (function () {
                    ...
                    function n(e) {
                        ...
                        let eleLength = document.getElementById("fileupload11");

                        // console.log(">>>>>>> "+eleLength.files.length); // logs number of files selected

                        if(o.length == 0){

                            if (o.length == a.fileLimit || a.fileLimit < o.length + e.length) {
                                const e = `The limit for number of file uploads is ${a.fileLimit}.`,
                                    t = $(".modal");
                            ...
                            for (let r = 0; r < e.length; r++) {
                                ...
                                }else if( (e[r].type != "image/png") && (e[r].type != "image/jpeg") && (e[r].type != "image/jpg") && (e[r].type != "image/gif")){

                                    console.log("======= "+e[r].type);

                                    const t = `\n File with " ${e[r].type} " type is not allowed !`,
                                        o = $(".modal");
                                    return o.find(".modal-body").html(t), void o.modal("show");
                                ...
                                $("<div class='row fileQueue'></div>").html(t).find(".col.name b").text(e[r].name).end().find(".remove input").attr("data-name", e[r].name).end().insertAfter(".row.ddHandler").animate({ opacity: 1 }, 850),
                                    o.push(e[r]);
                                // console.log(" >>>>>>> "+e[r].type);
                            ...
                            // console.log("========== "+o.length+" >>>>>>>>> "+a.fileLimit+" <<<<<<<<<< "+o.length + e.length);

                            $(".fileQueue").css("display","none");

                            if (eleLength.files.length > a.fileLimit) {
                                const e = `The limit for number of file uploads is ${a.fileLimit}.`,
                                    t = $(".modal");
                    ...
                    $.fn.initUploader = function (r) {
                        let i = { destination: null, destinationParams: null, sizeLimit: 1, fileLimit: 6, selectOpts: null, showDescription: !1, postFn: $.noop };
                        a = $.extend({}, i, r);
                        const s = { showDesc: a.showDescription, options: a.selectOpts },
                            l = e(s),
                            d = t();
                        this.html(l),
                            $("body").append(d),
                            a.destinationParams && (a.destination = `${a.destination}?${$.param(a.destinationParams)}`),
                            this.on("click change", "input[value]", (e) => {
                                "x" == e.currentTarget.attributes.value.nodeValue
                                    ? (function (e) {
                                    ...
                                    ? (function () {
                                          ...
                                          const r = $(".row.ulProgress .progress-bar"),
                                              n = $(".row.fileQueue");
                                          a.selectOpts && ((File.prototype.fileType = ""), o.map((e) => ((e.fileType = n.filter(`:has(input[data-name='${e.name}'])`).find(".col.desc input").val()), e))),
                                              a.showDescription && ((File.prototype.description = ""), o.map((e) => ((e.description = n.filter(`:has(input[data-name='${e.name}'])`).find(".col.options select").val()), e))),
                                              o.forEach((t) => e.append("file", t)),
